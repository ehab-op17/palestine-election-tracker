  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          Text(strings.newsSignals, style: Theme.of(context).textTheme.titleLarge),
          ...
          Text(strings.coverageMix, style: Theme.of(context).textTheme.titleMedium),
          const SizedBox(height: 4),
          Text(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(signal.source, style: const TextStyle(fontSize: 11, color: Colors.black45)),
              ),
              Text(signal.publishedAt, style: const TextStyle(fontSize: 10, color: Colors.black38)),
            ],
          ),
          const SizedBox(height: 6),
          Text(signal.title, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700, height: 1.25)),
          if (signal.summary.isNotEmpty) ...[
            const SizedBox(height: 6),
            Text(signal.summary, style: const TextStyle(fontSize: 12, color: Colors.black54, height: 1.35)),
          ],
          ...
          Row(
            children: [
              ...
              _Pill(label: '${AppStrings.of(context).impact} ${signal.impactScore.toStringAsFixed(1)}'),
            ],
          ),
        ],
      ),
...
class _Pill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: AppColors.parchment, borderRadius: BorderRadius.circular(999)),
